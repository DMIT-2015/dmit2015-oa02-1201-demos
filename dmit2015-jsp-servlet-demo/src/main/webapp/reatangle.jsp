  ...
  <body>
   ...
   <jsp:useBean id="rectangleBean" class="ca.nait.dmit.domain.Rectangle">
    ...
    <c:if test="${pageContext.request.method == 'POST'}">
    	<p>
    		Area = <strong>${rectangleBean.area()}</strong> <br />
    		Perimeter = <strong>${rectangleBean.perimeter()}</strong> <br />
    		Diagonal = <strong>
		    			<fmt:formatNumber type="number" maxFractionDigits="2" value="${rectangleBean.diagonal()}"></fmt:formatNumber>
    ...
    <form method="post">
    	...
    	<input type="number" id="length" name="length" value="${rectangleBean.length}"/>
    	
    	<label for="width">Width</label>
    	<input type="number" id="width" name="width" value="${rectangleBean.width}"/>
