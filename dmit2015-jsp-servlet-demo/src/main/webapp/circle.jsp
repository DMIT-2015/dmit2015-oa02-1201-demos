...
<html>
  ...
  <body>
  	...
  	<table class="table table-striped">
	  	...
	  	<c:forEach items="${circleBean.next10Circles()}" var="currentCircle">
	  		<tr>
				<td>${currentCircle.radius}</td>
				<td>${currentCircle.area()}</td>
				<td>${currentCircle.circumference()}</td>
				<td>${currentCircle.diameter()}</td>
	  		</tr>	  	
	  	</c:forEach>
  	</table>
