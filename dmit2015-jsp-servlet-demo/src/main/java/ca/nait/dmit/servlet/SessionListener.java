...
public class SessionListener implements HttpSessionListener {
    ...
    public void sessionCreated(HttpSessionEvent se)  { 
         ...
         Integer sessionCount = (Integer) application.getAttribute(ApplicationListener.SESSION_COUNT);
         ...
         application.setAttribute(ApplicationListener.SESSION_COUNT, sessionCount);
    }
