...
public class RectangleServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<p>The area is <strong>" + rectangle1.area() + "</strong> for a length of " 
				+ length 
				+ " and width of " + width
				+ "</p>");
		out.println("<p>The perimeter is <strong>" + rectangle1.perimeter() + "</strong> for a length of " 
				+ length 
				+ " and width of " + width
				+ "</p>");
		out.close();
