...
public class WebMail {
	...
	public WebMail() throws IOException {
		...
		// Load data from the javamail.properties
	...
	public static void main(String[] args) {
		try {
			...
			String subject = JOptionPane.showInputDialog("What is the subject of the email?");
			String message = JOptionPane.showInputDialog("What is the message of the email?");
			
			long startTime = System.currentTimeMillis();
			app.send(mailToEmail, mailToName, subject, message);
			long sendDuration = System.currentTimeMillis() - startTime;
			JOptionPane.showMessageDialog(null, "It took " + sendDuration + " milliseconds to send the mail.");
		} catch(Exception e) {
			e.printStackTrace();
