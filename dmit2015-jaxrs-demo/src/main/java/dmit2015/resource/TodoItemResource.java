 ...
 *
 ...
 curl -i -X GET http://localhost:8080/webapi/TodoItems

 curl -i -X GET http://localhost:8080/webapi/TodoItems/1

 curl -i -X POST http://localhost:8080/webapi/TodoItems \
 -d '{"name":"","complete":false}' \
 -H 'Content-Type:application/json'

 curl -i -X GET http://localhost:8080/webapi/TodoItems/5

 curl -i -X PUT http://localhost:8080/webapi/TodoItems/1 \
 -d '{"id":1,"name":"Submitted DMIT2015 assignment 7","complete":true}' \
 -H 'Content-Type:application/json'

 curl -i -X GET http://localhost:8080/webapi/TodoItems/5

 curl -i -X DELETE http://localhost:8080/webapi/TodoItems/3
